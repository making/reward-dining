...
public class Dining {
	 ...
	 */
	public Dining(MonetaryAmount amount, String creditCardNumber, String merchantNumber, LocalDate date) {
		this.amount = amount;
	...
	public static Dining createDining(String amount, String creditCardNumber, String merchantNumber) {
		return new Dining(USD.valueOf(amount), creditCardNumber, merchantNumber, LocalDate.now());
	}
	...
	public static Dining createDining(String amount, String creditCardNumber, String merchantNumber, int month,
			int day, int year) {
		return new Dining(USD.valueOf(amount), creditCardNumber, merchantNumber, LocalDate.of(year, month, day));
	}
